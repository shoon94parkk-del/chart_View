...
- Daily unique-browser totals persist in Render Key Value (10-day TTL) and survive web-service deploy/restart. activeNow and activeHome remain current-process heartbeat state by design.
