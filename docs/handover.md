...
- Daily unique-browser totals use the Render Key Value cache and survive normal app deploys/restarts; active-now/Home-active remain process-local. Treat the number as an anonymous browser estimate.
