...
- Daily unique-browser totals are stored in Render Key Value and survive normal app deploys/restarts; active-now/Home-active remain process-local. The metric is an anonymous-browser estimate rather than an exact person count.
