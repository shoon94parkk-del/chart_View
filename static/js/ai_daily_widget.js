(() => {
  ...
  document.addEventListener('chartview:v37-news-rendered', () => ensure(0));
  document.addEventListener('click', (event) => { if (event.target.closest('.app-bottom-btn[data-app-mode="home"]')) setTimeout(() => ensure(0), 60); });
