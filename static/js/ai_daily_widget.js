(() => {
  ...
  function addStyle(){
    ...
    style.textContent += `#home-tab .ai-daily-section.ai-daily-compact{padding:14px 16px}#home-tab .ai-daily-compact .ai-daily-head{margin-bottom:10px;align-items:center}#home-tab .ai-daily-compact .ai-daily-head h2{font-size:18px}#home-tab .ai-daily-compact .ai-daily-head p{font-size:11px}#home-tab .ai-daily-compact .ai-daily-today{margin-top:0;padding:10px 0;border-top:1px solid #f2f4f6;border-bottom:1px solid #f2f4f6}#home-tab .ai-daily-compact .ai-daily-performance{display:flex;align-items:center;gap:8px;margin-top:9px}#home-tab .ai-daily-compact .ai-daily-performance-main{display:flex;align-items:baseline;gap:7px;flex:1;padding:0;border:0;background:transparent}#home-tab .ai-daily-compact .ai-daily-performance-label{margin:0;font-size:10px}#home-tab .ai-daily-compact .ai-daily-performance-value{font-size:18px;line-height:1}#home-tab .ai-daily-compact .ai-daily-performance-main small{display:none}#home-tab .ai-daily-compact .ai-daily-kpis{display:flex;gap:6px}#home-tab .ai-daily-compact .ai-daily-kpi{min-width:auto;padding:5px 8px;border-radius:999px;background:#f7f8fa;border:0}#home-tab .ai-daily-compact .ai-daily-kpi span,#home-tab .ai-daily-compact .ai-daily-kpi b{display:inline;font-size:10px}#home-tab .ai-daily-compact .ai-daily-kpi b{margin-left:3px}@media(max-width:700px){#home-tab .ai-daily-section.ai-daily-compact{padding:12px}#home-tab .ai-daily-compact .ai-daily-performance{display:flex;flex-wrap:wrap}#home-tab .ai-daily-compact .ai-daily-kpis{width:100%}}`;
  ...
  function placeSection(){
    ...
    if(!s){s=document.createElement('section');s.id='ai-daily-section';s.className='ai-daily-section ai-daily-compact';} else s.classList.add('ai-daily-compact');
    if(h.watchlist?.parentElement===h.home)h.watchlist.insertAdjacentElement('afterend',s);
    else if(h.market?.parentElement===h.home)h.market.insertAdjacentElement('afterend',s);
