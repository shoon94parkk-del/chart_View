(() => {
  ...
  function compactHomeWatchlist() {
    ...
    // Keep the home surface intentionally short; the full watchlist remains one tap away.
    cards.slice(HOME_WATCHLIST_VISIBLE).forEach((card) => {
      card.style.display = 'none';
    });
    cards.slice(0, HOME_WATCHLIST_VISIBLE).forEach((card) => {
