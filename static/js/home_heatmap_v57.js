(() => {
  ...
  const HOME_SNAPSHOT_KEY = 'chartview-home-snapshot-v18';
  const HEATMAP_CACHE_KEY = 'chartview-home-heatmap-v68';
  const QUOTE_CACHE_KEY = 'chartview-watchlist-quotes-v35';
